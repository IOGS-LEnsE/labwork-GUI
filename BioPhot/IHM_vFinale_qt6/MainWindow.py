...
class Main_Window(QMainWindow):
    ...
    def __init__(self, mode = "Automatic"):
        ...
        relative_x_window = screen_resolution.width() * 0.0025  # Relative X-coordinate
        relative_y_window = screen_resolution.height() * 0.05  # Relative Y-coordinate
        relative_width_window = screen_resolution.width() * 0.650  # Relative width
        relative_height_window = screen_resolution.height() * (0.9) # Relative height
